  ...
  return (
    <section className="py-12 px-4 md:px-8 max-w-7xl mx-auto">
      <div className="relative rounded-2xl overflow-hidden bg-primary h-[400px] flex items-center shadow-lg group">
        <img src={promotional.image} alt={promotional.heading} className="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-overlay transition-transform duration-700 group-hover:scale-105"/>
